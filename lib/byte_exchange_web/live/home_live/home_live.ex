defmodule ByteExchangeWeb.HomeLive do
  ...
  def render(assigns) do
    ...
    <div class="flex">
      ...
      <div class="bg-slate-900 h-[100vh] w-[20rem] mr-3 justify-end relative w-fit hidden lg:block p-4 rounded-md shadow-2xl">
        <.link
        ...
        <div>
          <h3 class="font-bold mb-4"><.icon name="hero-bookmark" />Subscribed Threads</h3>
          <.thread
