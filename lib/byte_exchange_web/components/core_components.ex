defmodule ByteExchangeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ByteExchangeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ByteExchangeWeb.Gettext, "errors", msg, opts)
    end
  end
